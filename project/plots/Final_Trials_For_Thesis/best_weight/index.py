...
if __name__ == '__main__':
    ...
    for trains_in_in_specefic_weight in range(0, trains_in_range_weight_iteration):
        ...
        for trial in range(0, number_of_trials):
            ...
            plt.grid()
            # plt.savefig('./plots/plots_in_range/Trial_{}_best_test_{}_hyperedge_weight {:.4f}.png'
            #             .format(trial, test_best, hyperedge_weight[0]), dpi=300)
            plt.savefig('plots/Final_Trials_For_Thesis/best_weight/Trial_{}_best_test_{}_hyperedge_weight {:.4f}_with_100_epoc.png'
                        .format(trial, test_best, hyperedge_weight[0]), dpi=300)
            # plt.show()
            # ------------------------------------------------------------------------

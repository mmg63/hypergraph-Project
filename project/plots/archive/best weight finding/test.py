...
if __name__ == '__main__':
    ...
    for weight in range(1, number_of_trials):
        ...
        plt.grid()
        plt.savefig('./plots/best weight for hyperedge_weight +2/plot_{} with 200 epoch in best hyperedge_weight_results execution.png'.format(weight), dpi=300)
        plt.show()
        # ------------------------------------------------------------------------

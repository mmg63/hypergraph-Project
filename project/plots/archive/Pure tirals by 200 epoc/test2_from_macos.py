...
if __name__ == '__main__':
    ...
    for weight in range(1, 21):
        ...
        hyperedge_weight += 0.5
        model = None
        model = Hyper_Attention_Class(data=data, hyperedge_weight=None)  # model = GAT_Net_Class()
        ...
        for epoch in range(1, number_of_epochs):
            ...
            log = 'Epoch: {:03d} --> accuracy: Train: {:.4f}, Val: {:.4f}, Test: {:.4f}'
        ...
        plt.grid()
        plt.savefig('./plots/plot_{} with 200 epoch in pure execution.png'.format(weight), dpi=300)
        plt.show()
        # ------------------------------------------------------------------------
